            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="{{ route('register_nanda') }}" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" id="name" class="block mt-1 w-full" type="text" name="name"
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Password is required">
                        <input class="input100" id="password_confirmation" class="block mt-1 w-full" type="password"
