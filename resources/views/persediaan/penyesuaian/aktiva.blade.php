<x-theme.app title="{{ $title }}" table="Y" sizeCard="12">
    ...
    <x-slot name="cardBody">
        <form action="{{ route('jurnalpenyesuaian.save_penyesuaian_aktiva') }}" method="post" class="save_jurnal">
            @csrf
            <div class="row mb-4">
                <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" name="id_akun_debit" value="27">
                                ...
                                <td>
                                    <input type="text" readonly class="text-end form-control total"
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="id_akun_kredit" value="26">
