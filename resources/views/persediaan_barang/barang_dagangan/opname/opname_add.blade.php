<x-theme.app title="{{ $title }}" table="Y" sizeCard="12">
    ...
    <x-slot name="cardHeader">
        <form action="{{ route('barang_dagangan.opname.save') }}" method="post">
            @csrf
            ...
            <div class="row justify-content-end">
                ...
                <div class="col-lg-4">
                    <select name="" class="form-control select-gudang" id="select2">
                        ...
                        @foreach ($gudang as $g)
                            <option {{ Request::segment(4) == $g->id_gudang ? 'selected' : '' }}
                                value="{{ $g->id_gudang }}">
    ...
    @section('scripts')
        <script>
            ...
            $(".select-gudang").change(function(e) {
                    ...
                    document.location.href = `/barang_dagangan/opname/add/${gudang_id}`
                });
