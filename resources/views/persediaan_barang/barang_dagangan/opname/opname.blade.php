...
title="{{ $title }}" 
nav="Y" 
rot1="barang_dagangan.index"
rot2="barang_dagangan.stok_masuk"
rot3="barang_dagangan.opname"
table="Y" 
sizeCard="12">
    <x-slot name="cardHeader">
        ...
        <div class="row justify-content-end">
            ...
            <div class="col-lg-2">
                <a href="{{ route('barang_dagangan.opname.add') }}" class="btn btn-primary float-end"> <i class="fas fa-plus"></i>
                    Tambah</a>
            </div>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        @if ($d->jenis == 'draft')
                                            <li>
                                                <a class="dropdown-item text-primary edit"
                                                    href="{{ route('barang_dagangan.opname.edit', ['no_nota' => encrypt($d->no_nota)]) }}"><i
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger"
                                                    ...
                                                    href="{{ route('barang_dagangan.opname.delete', $d->no_nota) }}"><i
                                        ...
                                        <li>
                                            <a class="dropdown-item text-info"
                                                href="{{ route('barang_dagangan.opname.cetak', ['no_nota' => encrypt($d->no_nota)]) }}"><i
        ...
        <script>
            $(document).ready(function() {
                ...
                $(".select-gudang").change(function(e) {
                    ...
                    document.location.href = `/barang_dagangan/opname/${gudang_id}`
                });
