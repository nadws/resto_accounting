<div x-data="{}">
    ...
    <div class="row">
        ...
        @foreach ($duit as $i => $d)
            <div class="col-lg-6 col-6 mb-2">
                <button
                    ...
                    nominal="{{ $d == 1 ? 1000 : $d }}" count="{{ $i + 1 }}" wire:click="setNominal({{ $d == 1 ? 1000 : $d }})">
        ...
        <div class="col-lg-12 col-12 mt-3">
            ...
            <form id="submitUang">
                <input value="{{number_format($nominal,0)}}" 
                    style="font-size:30px;height: 50px; font-weight: bold" placeholder="Rp. "
                    class="form-control">
