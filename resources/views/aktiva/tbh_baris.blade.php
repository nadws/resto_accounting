<tr class="baris{{$count}}">
    <td>
        <select name="id_kelompok[]" id="" class="select pilih_kelompok pilih_kelompok{{$count}}" count='{{$count}}'>
    ...
    <td>
        <input type="text" class="form-control nilai_perolehan nilai_perolehan{{$count}}" count="{{$count}}">
