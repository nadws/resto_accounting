<tr class="baris{{ $count }}">
    ...
    <td align="right">
        <input type="text" class="form-control pcs pcs{{ $count }}" count="{{ $count }}" style="text-align: right"
            required>
        <input type="hidden" class="form-control  pcs_biasa{{ $count }}" value="0" name="pcs[]">
    </td>
    <td align="right">
        <input type="text" class="form-control kg kg{{ $count }}" count="{{ $count }}" style="text-align: right"
            required>
        <input type="hidden" class="form-control kgbiasa kgbiasa{{ $count }}" count="{{ $count }}" value="0"
            name="kg[]">
    </td>
    <td align="right">
        <input type="text" class="form-control ikat{{ $count }}" value="0" name="ikat[]">
    </td>
    <td align="right">
        <input type="text" class="form-control kgminrakbiasa{{ $count }}" value="0" name="kg_jual[]">
    </td>
    <td align="right">
