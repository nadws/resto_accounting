<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <input type="hidden" class="form-control nota_grading" name="no_nota">
    </div>
    <div class="col-lg-4">
        <label for="">Gram Basah</label>
        <input type="text" class="form-control" name="gr_basah" value="0">
    </div>
    <div class="col-lg-4 mt-2">
        <label for="">Pcs Awal</label>
        <input type="text" class="form-control" name="pcs_awal" value="0">
    </div>
    <div class="col-lg-4 mt-2">
        <label for="">Gr Kering</label>
        <input type="text" class="form-control" name="gr_kering" value="0">
    </div>
    @else
    <div class="col-lg-4">
        <label for="">Tanggal</label>
