{{-- modal --}}
<form id="form_tambah_obat_air" method="post">
    @csrf
    <x-theme.modal title="Tambah Obat Air" size="modal-lg" idModal="tambah_obat_air">
        @php
        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                <select name="dosis_satuan" class="form-control select2-air" id="">
            ...
            <div class="col-lg-2">
                ...
                <select name="campuran_satuan" class="form-control select2-air" id="">
                    <option value="">- Pilih Satuan -</option>
                    @foreach ($satuanObat as $s)
                        <option value="{{ $s->id_satuan }}">{{ ucwords($s->nm_satuan) }}</option>
                    @endforeach
