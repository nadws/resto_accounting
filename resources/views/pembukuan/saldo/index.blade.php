                ...
                <table class="table table-hover" id="tablealdi">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: right" width="220px">Kredit</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($akun as $no => $a)
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" onclick="selectAllText(this)"
