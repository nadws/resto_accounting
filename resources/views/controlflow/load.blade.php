        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td><a href="#" onclick="event.preventDefault();" class="tmbhakun"
                        id_kategori="{{$c->id_kategori_cashcontrol }}" tgl1="{{$tgl1}}" tgl2="{{$tgl2}}"
                        style="padding-left: 20px">{{$c->nama}}</a></td>
            ...
            <tr>
                <td>
                    <a href="#" onclick="event.preventDefault();" tgl1="{{$tgl1}}" tgl2="{{$tgl2}}" class="tmbhakun"
                        id_kategori="{{$c->id_kategori_cashcontrol }}" style="padding-left: 20px">{{$c->nama}}</a>
                </td>
