<header class="mb-5">
    ...
    <nav class="main-navbar ">
        <div class="container font-bold">
            <ul>
                <li class="menu-item">
                    <a href="dashboard" class='menu-link {{ request()->route()->getName() == ' dashboard'
                        ? 'active_navbar_new' : '' }}'>
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                'summary_buku_besar.detail', 'profit', 'cashflow.index', 'penutup.index', 'controlflow','neraca'],
                ],
                [
                'nama' => 'Penjualan',
                'route' => 'penjualan',
                ...
                'stok_masuk.add', 'bahan_baku.index', 'bahan_baku.stok_masuk', 'bahan_baku.stok_masuk_segment',
                'bahan_baku.opname', 'peralatan.add', 'penyesuaian.atk', 'penyesuaian.atk_gudang','penyesuaian.aktiva',
                'penyesuaian.index', 'asset', 'aktiva'],
                ],
                ];
                @endphp
                @foreach ($nav as $d)
