                ...
                @php
                    ...
                    $nav = [
                        ...
                        [
                            'nama' => 'Buku Besar',
                            'route' => 'buku_besar',
                            'isi' => ['buku_besar', 'akun', 'jurnal', 'jurnal.add', 'summary_buku_besar.index', 'saldo_awal', 'summary_buku_besar.detail', 'profit', 'cashflow.index', 'penutup.index', 'penyesuaian.aktiva', 'penyesuaian.index', 'penyesuaian.atk'],
                        ],
                        [
                            'nama' => 'Penjualan',
                            'route' => 'penjualan',
